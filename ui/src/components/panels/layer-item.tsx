...
export function LayerItem({ layerId }: LayerItemProps) {
  ...
  return (
    <div
      className={cn(
        "group flex flex-col gap-1 rounded-lg border px-2 py-1.5 cursor-pointer transition-all duration-150",
        isActive
    ...
    >
      ...
      {isActive && (
        <div className="flex items-center gap-2 pl-10 pr-0.5">
          <Slider
            ...
            className="flex-1"
          />
          <span className="w-7 shrink-0 text-right text-[11px] tabular-nums text-neutral-500">
